 ...
 */
final class Version20241119115433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, equipe_a_id INT NOT NULL, equibe_b_id INT NOT NULL, score VARCHAR(70) NOT NULL, UNIQUE INDEX UNIQ_329937513297C2A6 (equipe_a_id), UNIQUE INDEX UNIQ_32993751D063E0AF (equibe_b_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE score ADD CONSTRAINT FK_32993751D063E0AF FOREIGN KEY (equibe_b_id) REFERENCES equipe (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score DROP FOREIGN KEY FK_32993751D063E0AF');
